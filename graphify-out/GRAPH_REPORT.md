...
- `Route Protection & Middleware Flow` --conceptually_related_to--> `Authentication Flow`  [INFERRED]
  routes.md → memory.md
...
Cohesion: 0.10
Nodes (17): dynamic, revalidate, AspirantPainPoints(), CutoffContrastData, FAQ(), Footer(), HeroSection(), HowToPurchase() (+9 more)
...
## Knowledge Gaps
- **108 isolated node(s):** `SiteContent`, `CutoffContrastData`, `ActivityItem`, `SyllabusItem`, `RichTextEditorProps` (+103 more)
...
- **What connects `SiteContent`, `CutoffContrastData`, `ActivityItem` to the rest of the system?**
